        ...
        <table align="center" class="table mt-3 table-striped table-bordered">
            ...
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td  width="20%">
                        <img src="<?php echo e(asset("storage/".$category->image)); ?>" class="img-responsive img-circle" alt="No Image Found" style="width:80px">
                   <td>
...
<?php echo $__env->make("layouts.admin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Resturant-Manegment\resources\views/admin/category/index.blade.php ENDPATH**/ ?>