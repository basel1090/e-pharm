...
<div class="portlet light ">
                            ...
                            <form class="portlet-body">
                                <div class='row'>
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <a href="{{ route('brands.create') }}" class='btn btn-success'><i class='fa fa-plus'></i> Add New Brand</a>
                                    </div>
</div>
                                </form>
                                <hr>
                    ...
                    <form method="post" action="{{ route('brands.destroy', $brand->id) }}">
                        <a href="{{ route("brands.show", $brand->id) }}" class="btn btn-info btn-sm"><i class='fa fa-eye'></i></a>
