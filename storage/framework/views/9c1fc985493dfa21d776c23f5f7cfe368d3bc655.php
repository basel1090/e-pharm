                ...
                <tr>
                   ...
                   <td>
                       <?php if($category->published): ?>
                           <a href="<?php echo e(route('category.pending',$category->id)); ?>" style="width: 80px" class="btn btn-success btn-sm" >Active</a>
                       <?php else: ?>
                           <a href="<?php echo e(route('category.confirm',$category->id)); ?>" style="width: 80px"  class="btn btn-warning btn-sm">Pending</a>
...
<?php echo $__env->make("layouts.admin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp9\htdocs\e-pharm\resources\views/admin/category/index.blade.php ENDPATH**/ ?>