        ...
        <table align="center" class="table mt-3 table-striped table-bordered">
            ...
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><img width="100" src='<?php echo e(asset("storage/".$product->image)); ?>' ></td>
                    ...
                    <td width="20%">
                        ...
                        <form method="post" action="<?php echo e(route('products.destroy', $product->id)); ?>">
                            <a href="<?php echo e(route('products.show', $product->id)); ?>" class="btn btn-success btn-sm"><i
                                    class='fa fa-eye'></i></a>
...
<?php echo $__env->make("layouts.admin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp9\htdocs\e-pharm\resources\views/admin/product/index.blade.php ENDPATH**/ ?>