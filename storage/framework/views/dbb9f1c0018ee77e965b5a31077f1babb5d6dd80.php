    ...
    <form  role="form">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <select class="form-control <?php echo e($errors->has('category_id')?'is-invalid':''); ?>" id="exampleFormControlSelect1" name="category_id" id="category_id"  >
                    <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option  <?php echo e($category->id?"selected":""); ?> value='<?php echo e($category->id); ?>' disabled><?php echo e($category->title); ?></option>
            ...
            <div>
                ...
                <a class='btn btn-danger' href='<?php echo e(route('products.index')); ?>'>Back</a>
            </div>
        </div>
    </form>
<?php $__env->stopSection(); ?>

<?php echo $__env->make("layouts.admin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ahmed\Desktop\pharm\e-pharm\resources\views/admin/product/show.blade.php ENDPATH**/ ?>